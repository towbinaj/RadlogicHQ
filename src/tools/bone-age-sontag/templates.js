const FINDINGS_BLOCKS = [
  { id: 'method', label: 'Method', template: 'Method: Sontag', enabled: true },
...
const IMP = 'Bone age {{boneAgeLabel}} by Sontag method. {{interpretation}}.';

export const boneAgeSontagTemplates = {
  ...
  radai: { label: 'RadAI Omni', ...bts([
    ...
    { id: 'ossification', label: 'Count', template: 'Ossification_Centers: {{ossificationCount}}', enabled: true, condition: 'ossificationProvided' },
