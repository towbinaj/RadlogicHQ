...
export const niradsDefinition = {
  ...
  primaryCategories: [
    { id: '1', label: '1 — No evidence of recurrence', findings: 'Expected post-treatment changes only', management: 'Routine surveillance', recurrence: 'approx 4%' },
    { id: '2a', label: '2a — Low suspicion (superficial)', findings: 'Superficial mucosal enhancement or ill-defined soft tissue', management: 'Direct visualization', recurrence: 'approx 29%' },
    { id: '2b', label: '2b — Low suspicion (deep)', findings: 'Deep or submucosal enhancement, mild-moderate FDG uptake', management: 'Short-interval follow-up (3 months) or PET', recurrence: 'approx 29%' },
    { id: '3', label: '3 — High suspicion', findings: 'New or enlarging mass, marked enhancement or intense FDG uptake', management: 'Biopsy recommended', recurrence: 'approx 74%' },
    { id: '4', label: '4 — Definite recurrence', findings: 'Pathologically proven or unmistakable progression', management: 'Treatment', recurrence: 'approx 100%' },
  ],
