...
export const toolsRegistry = [
  ...
  },
  {
    id: 'vur',
    name: 'VUR Grading',
    description: 'Vesicoureteral reflux grading for VCUG and nuclear medicine cystography.',
    icon: 'VR',
  ...
  },
  {
    id: 'bone-age',
    name: 'Bone Age',
    description: 'Bone age assessment using Greulich & Pyle and Sontag methods.',
    icon: 'BA',
